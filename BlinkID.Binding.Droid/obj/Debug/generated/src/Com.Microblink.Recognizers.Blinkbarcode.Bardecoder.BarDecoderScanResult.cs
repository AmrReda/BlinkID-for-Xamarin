...
namespace Com.Microblink.Recognizers.Blinkbarcode.Bardecoder {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.microblink.recognizers.blinkbarcode.bardecoder']/class[@name='BarDecoderScanResult']"
	[global::Android.Runtime.Register ("com/microblink/recognizers/blinkbarcode/bardecoder/BarDecoderScanResult", DoNotGenerateAcw=true)]
	public partial class BarDecoderScanResult : global::Com.Microblink.Recognizers.BaseRecognitionResult {


		static IntPtr CREATOR_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.microblink.recognizers.blinkbarcode.bardecoder']/class[@name='BarDecoderScanResult']/field[@name='CREATOR']"
		[Register ("CREATOR")]
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/microblink/recognizers/blinkbarcode/bardecoder/BarDecoderScanResult", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (BarDecoderScanResult); }
		}

		protected BarDecoderScanResult (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_JZZ;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.microblink.recognizers.blinkbarcode.bardecoder']/class[@name='BarDecoderScanResult']/constructor[@name='BarDecoderScanResult' and count(parameter)=3 and parameter[1][@type='long'] and parameter[2][@type='boolean'] and parameter[3][@type='boolean']]"
		[Register (".ctor", "(JZZ)V", "")]
		public unsafe BarDecoderScanResult (long p0, bool p1, bool p2)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (BarDecoderScanResult)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.microblink.recognizers.blinkbarcode.bardecoder']/class[@name='BarDecoderScanResult']/constructor[@name='BarDecoderScanResult' and count(parameter)=1 and parameter[1][@type='android.os.Parcel']]"
		[Register (".ctor", "(Landroid/os/Parcel;)V", "")]
		protected unsafe BarDecoderScanResult (global::Android.OS.Parcel p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
...
#pragma warning disable 0169
		...
		{
			global::Com.Microblink.Recognizers.Blinkbarcode.Bardecoder.BarDecoderScanResult __this = global::Java.Lang.Object.GetObject<global::Com.Microblink.Recognizers.Blinkbarcode.Bardecoder.BarDecoderScanResult> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Com.Microblink.Recognizers.Blinkbarcode.BarcodeType BarcodeType {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.microblink.recognizers.blinkbarcode.bardecoder']/class[@name='BarDecoderScanResult']/method[@name='getBarcodeType' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Com.Microblink.Results.Barcode.BarcodeDetailedData ExtendedRawData {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.microblink.recognizers.blinkbarcode.bardecoder']/class[@name='BarDecoderScanResult']/method[@name='getExtendedRawData' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string ExtendedStringData {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.microblink.recognizers.blinkbarcode.bardecoder']/class[@name='BarDecoderScanResult']/method[@name='getExtendedStringData' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Com.Microblink.Results.Barcode.BarcodeDetailedData RawData {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.microblink.recognizers.blinkbarcode.bardecoder']/class[@name='BarDecoderScanResult']/method[@name='getRawData' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string StringData {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.microblink.recognizers.blinkbarcode.bardecoder']/class[@name='BarDecoderScanResult']/method[@name='getStringData' and count(parameter)=0]"
